...
describe("findAll", function () {
  ...
  test('works: with filter minEmployees and maxEmployees', async function () {
  ...
  test('works: with filter name, minEmployees, and maxEmployees', async function () {
    let companies = await Company.findAll({name: 'C', minEmployees: 2, maxEmployees: 10});
    expect(companies).toEqual([
      {
        handle: "c2",
        name: "C2",
